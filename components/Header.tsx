  ...
  return (
    <header className="hdr">
      <div className="container hdr-in">
        ...
        <OfflineStatus />
        <ThemeToggle />
        <a className="hdr-gh" href="https://github.com/Tirth-Babariya/" target="_blank" rel="noopener noreferrer" aria-label="Tirth Babariya on GitHub" title="GitHub — Tirth Babariya">

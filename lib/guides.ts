...
export const GUIDES: Guide[] = [
  ...
  {
    slug: "make-wifi-qr-code",
    tool: "qr-code-generator",
    title: "How to make a QR code for your Wi-Fi (or any link)",
    description: "Create a free QR code that connects guests to your Wi-Fi in one scan, or opens a link, contact or map. Download PNG or SVG — made on your device.",
    minutes: 2,
    intro: "Nobody likes reading out a long Wi-Fi password. A QR code lets guests point their camera and join. The same maker builds codes for links, contacts, email, phone numbers and locations — and your password is never sent anywhere.",
    short: "Open the QR code maker, choose Wi-Fi, type the network name and password, pick the security type, then download the PNG and print it.",
    steps: [
      { title: "Open the QR code maker and pick a type", body: "Choose Wi-Fi for a network, or Link, Text, Contact, Email, Phone, SMS or Location for other codes." },
      { title: "Enter the details", body: "For Wi-Fi: the network name exactly as it appears, the password, and the security type. Most home routers use WPA/WPA2. Tick Hidden network only if it doesn’t show up in the list of networks." },
      { title: "Style it if you like", body: "Change colours, pick rounded or dotted shapes, or add a logo. Keep a dark code on a light background — the maker warns you if the contrast is too low." },
      { title: "Download and test", body: "Download PNG for printing or SVG for sharp scaling. Scan it with your own phone before you print copies." },
    ],
    tips: [
      "Print it at least 2 × 2 cm, with an empty border around it.",
      "Changed your Wi-Fi password? The code contains the old one, so make a new code.",
      "Adding a logo raises error correction automatically, but always test the result.",
    ],
    faq: [
      { q: "Is my Wi-Fi password sent anywhere?", a: "No. The code is drawn in your browser and the password never leaves your device." },
      { q: "Will the code stop working?", a: "No. It isn’t a link to a service — it simply contains the details, so it works as long as they stay the same." },
      PRIVATE_Q,
    ],
    related: ["scan-qr-code-from-image", "check-pdf-metadata", "password-protect-a-pdf"],
  },
  {
    slug: "scan-qr-code-from-image",
    tool: "qr-code-reader",
    title: "How to scan a QR code from an image or screenshot",
    description: "Read a QR code from a saved picture, a screenshot or your camera — and check where it leads before you open it. Free and private.",
    minutes: 2,
    intro: "A QR code in a screenshot or a PDF can’t be scanned with a camera. This reader decodes it from the image itself, on your device, and shows you what’s inside before you do anything with it.",
    short: "Open the QR code reader, drop the image or paste a screenshot with Ctrl/⌘+V, and read the decoded result — or press Scan with camera.",
    steps: [
      { title: "Open the QR code reader", body: "You can also drop a picture on any page and choose the reader from the suggestions." },
      { title: "Add the image", body: "Drop a file, browse for one, or paste a screenshot straight from the clipboard. Several images at once are fine." },
      { title: "Read what it says", body: "A link shows its full address, a Wi-Fi code shows the network and password (hidden until you press Show), and a contact card lists its fields." },
      { title: "Copy or open", body: "Copy the text, copy the Wi-Fi password, or open the link or map if you trust it." },
    ],
    tips: [
      "Crop tightly around the code if a big screenshot isn’t detected.",
      "Blurry or very small codes are harder to read — a sharper photo with a plain border helps.",
      "Want to use the camera? Press Scan with camera and allow access; the video never leaves your device.",
    ],
    faq: [
      { q: "Can it read barcodes on products?", a: "Not yet — only QR codes are supported." },
      { q: "Is it safe to open a scanned link?", a: "The reader never opens anything by itself and shows the full address first. Only open links you trust." },
      PRIVATE_Q,
    ],
    related: ["make-wifi-qr-code", "check-pdf-metadata", "compress-image-to-100kb"],
  },
  {
    slug: "check-pdf-metadata",
    tool: "document-properties",
    title: "How to check (and remove) a PDF’s metadata",
    description: "See which program created a PDF, who the author is and when it was made — then edit or wipe it. Works for Word, Excel, PowerPoint and JPG too.",
    minutes: 3,
    intro: "Every PDF quietly records who made it and with what: the author, the program that generated it, and the dates. Word, Excel, PowerPoint files and photos do the same — photos can even store the GPS location. You can read, change or remove all of it here, without uploading the file.",
    short: "Open Document properties, drop the file, read the Creator and Producer fields, then edit them or press Remove all metadata and download the copy.",
    steps: [
      { title: "Open Document properties and add the file", body: "It works with PDF, .docx, .xlsx, .pptx and JPG files. Older .doc / .xls / .ppt files aren’t supported." },
      { title: "Read who made it", body: "The top boxes show the program: for a PDF, “Creator” is where the content was written (like Word) and “Producer” is what created the PDF file. Below you’ll find the title, author, dates, page count and more." },
      { title: "Edit or remove", body: "Change any field and press Save changes, or press Remove all metadata to wipe the author, company, dates and other properties." },
      { title: "Download the new copy", body: "Your original is never touched. The new file is saved next to it as name-edited or name-clean." },
    ],
    tips: [
      "Photos from a phone often contain the exact GPS location — remove it before posting a photo publicly.",
      "Word files can also carry comments and tracked changes. They’re listed as a warning but they are content, so remove them in Word itself.",
      "An empty Producer field means the generator left it blank or someone removed it — you can’t recover it.",
      "Password-protected PDFs hide their properties. Unlock the PDF first.",
    ],
    faq: [
      { q: "Can I change the dates and author?", a: "Yes, for PDF and Office files. It only changes the properties, not the content." },
      { q: "Does removing metadata change how the file looks?", a: "No. Pages, text and pictures stay exactly the same. JPG photos are copied byte for byte with only the metadata blocks left out." },
      { q: "Can it edit photo metadata field by field?", a: "Not yet — for photos you can read everything and remove it all." },
      PRIVATE_Q,
    ],
    related: ["password-protect-a-pdf", "reduce-pdf-size-under-200kb", "make-wifi-qr-code"],
  },
];
